  ...
  return (
    <div className='d-flex align-items-stretch flex-shrink-0'>
      <div className='topbar d-flex align-items-stretch flex-shrink-0'>
        ...
        {/* <span className="my-auto mx-4  heart-icon cursor-pointer">
        <a
                                        href="index.html"
                                        className="btn btn-icon btn-custom text-muted btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px"
                                        // data-kt-menu-trigger="click"
            ...
            <div className="menu menu-sub bg-text-muted menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-175px" data-kt-menu="true" data-kt-element="theme-mode-menu">
